<!-- BADGES:START -->
[![CI](https://github.com/POps-Rox/tf-az-overlays-containerinstance/actions/workflows/ci.yml/badge.svg)](https://github.com/POps-Rox/tf-az-overlays-containerinstance/actions/workflows/ci.yml)
